...
public class Player {
	...
	public void SelectChar() {
		...
		System.out.println("--------------------------------------");
		System.out.println("ID| Karekter | Hasar | Saðlýk | Para | ");
		...
		System.out.println("--------------------------------------");
		System.out.print("Lütfen bir karekter seç : ");
		...
		System.out.println(this.getCharName() + " Karekterini Seçtin.");
	}
	...
	public void printInfo() {
		System.out.println("Silah : " + this.getInventory().getWeapon().getName() + ", Hasar : " + this.getTotalDamage()
				+ ", Saðlýk : " + this.getHealth() + ", Zýrh : " + this.getInventory().getArmor().getName()
